                        ...
                        <div class="col-md-9 col-lg-8 mx-auto">
                            ...
                            <form action="<?php echo site_url('member/check_member') ?>" method="post">
                                <div class="form-label-group">
                                    <input type="text" name="ID_CARD" id="inputID" placeholder="รหัสบัตรประชาชน" class="form-control form-group" required autofocus>
                                    <label for="inputID">รหัสบัตรประชาชน</label>
                                </div>
                                <div class="form-label-group">
